...
public class ShortCircutApp {
	...
	public static void main(String[] args) {
		...
		System.out.print("How far away is the light (in feet)?");
		int feet = sc.nextInt();
		...
		if (light.equalsIgnoreCase("r")) {
			...
			//light is yellow and we are super close, stop!!
			if (mph> 60) {
				// speed up!
			}
			else {
			...
			// light is yellow and we are far away - slow to stop
		}
}
}	
